...
public class VEModelLayers {
    public static final ModelLayerLocation CERULEAN_BOAT_LAYER = new ModelLayerLocation(
            new ResourceLocation(EnlightenedEndMod.MODID, "boat/cerulean"), "main");
    public static final ModelLayerLocation CERULEAN_CHEST_BOAT_LAYER = new ModelLayerLocation(
